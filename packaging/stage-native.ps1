...
try {
    ...
    $env:X_VCPKG_REGISTRIES_CACHE = "$OutputDirectory/registries"
    $env:VCPKG_DISABLE_METRICS = '1'
    # Keep prepared Python generator sources free of generated bytecode.
    $env:PYTHONDONTWRITEBYTECODE = '1'
    New-Item -ItemType Directory -Force $env:VCPKG_DOWNLOADS, $env:VCPKG_DEFAULT_BINARY_CACHE, $env:X_VCPKG_REGISTRIES_CACHE | Out-Null
